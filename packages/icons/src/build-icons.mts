...
const inputDirectory = path.join(cwd, 'src', 'svg-sources');
...
// biome-ignore lint/suspicious/noConsole: should not be linting
...
async function generateIconFiles() {
  ...
  const typeOutputContent = `// This file is generated by build:icons;
